...
async def download_video(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if is_url(message_text):
        ...
        try:
            ...
            filename = await loop.run_in_executor(executor, download_video_task, message_text)
            ...
            await update.message.reply_text(f"Failed to download. Please try again later.")
    else:
